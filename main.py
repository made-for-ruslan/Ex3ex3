...
class Gardener:
    ...
    def harvest(self):
        if self._plant.all_are_ripe():
            ...
            print('Готово,всё собрали,содитесь есть!')
        else:
            print('Рано,еще не созрело!!!')

    @staticmethod
    def knowledge_base():
        print('Здесь должна быть справка по садоводству или Google_gardening')


Gardener.knowledge_base()
bush = TomatoBush(6)
gardener = Gardener('George', bush)
gardener.work()
gardener.harvest()
gardener.work()
gardener.harvest()